...
![kNN Algorithm](/Users/Han/KHURStudy/Machine Learning/images/kNN_ex1.jpg) 
...
$$
d_m(p, q) = \| p - q \|_1 =  \sum^n_{i = 1} |p_i - q_i|
$$
...
```{r}
wbcd <- read.csv("./data/wisc_bc_data.csv", header = TRUE, stringsAsFactors = FALSE)
